...
$I''_{k3}$ en barra de 800\,V & \parcial{$\approx$13--15\,kA} & Recalcular con $Z=6\,\%$ \\ \hline
Falla en 800\,V, referida a 13.2\,kV & $\approx$806\,A & $I''_{k,BT}\times(800/13200)$ \\ \hline
...
\begin{itemize}
\item \textbf{Arranque de 51 (70\,A)}: 1.25 veces la corriente nominal del transformador (54.7\,A), que es la m\'axima corriente de r\'egimen permanente que puede circular por el PC. Queda muy por debajo de los $\approx$806\,A que produce una falla en el lado de 800\,V, de modo que la funci\'on cubre toda la zona propia.
\item \textbf{Arranque de 50 (1100\,A)}: se escoge \emph{por encima} de los $\approx$806\,A de la falla en 800\,V (con 35\,\% de margen), para que el instant\'aneo \textbf{no} opere ante fallas en el lado de baja tensi\'on --- esas las despeja el interruptor ACB de 1000\,A del tablero de BT, que es su protecci\'on primaria. As\'i se conserva la selectividad entre ambos niveles. Al mismo tiempo queda muy por debajo de los 4155\,A disponibles en el PC, de modo que una falla en la celda o en el lado de media del transformador se despeja instant\'aneamente.
...
La condici\'on cr\'itica es una falla trif\'asica en la barra de 800\,V, que es la m\'axima corriente que ven simult\'aneamente la protecci\'on del proyecto y la de cabecera. Referida a 13.2\,kV, esa corriente vale $\approx$806\,A. Aplicando la f\'ormula IEC 60255-151 Normal Inverse, $t = \text{Dial}\times 0.14 / ((I/I_{arr})^{0.02}-1)$:

\begin{center}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Protecci\'on} & \textbf{Arranque} & \textbf{Dial} & \textbf{$I/I_{arr}$} & \textbf{Tiempo de disparo} \\ \hline
Proyecto (51, PC) & 70\,A & 0.05 & 11.51 & \textbf{0.14\,s} \\ \hline
Cabecera 15344 (51) & 240\,A & 0.10 & 3.36 & 0.57\,s \\ \hline
\multicolumn{4}{|r|}{\textbf{Margen de selectividad}} & \textbf{0.43\,s} \\ \hline
\end{tabular}
\end{center}

El margen de 0.43\,s supera el criterio habitual de 0.2--0.3\,s entre protecciones en serie, de modo que ante una falla en la instalaci\'on del proyecto abre primero el interruptor del PC y el circuito 15344 permanece en servicio para el resto de los usuarios. En sentido inverso, ante una falla en el alimentador de EBSA la protecci\'on del proyecto no alcanza su arranque (solo ve los 43.3\,A de aporte propio), de modo que no existe riesgo de disparo indebido del proyecto por fallas ajenas: la desconexi\'on en ese escenario la producen las funciones 27/81/81R dentro del plazo de 2\,s impuesto por el recierre.
...
\item El esquema de protecci\'on del proyecto y sus ajustes quedan definidos en la Secci\'on~\ref{sec:protecciones-proyecto}, con un margen de selectividad de 0.43\,s respecto a la protecci\'on de cabecera. La restricci\'on dimensionante no es la sobrecorriente sino el \textbf{recierre r\'apido de 2\,s} de la cabecera, que fija el plazo m\'aximo de desconexi\'on del proyecto ante fallas externas.
