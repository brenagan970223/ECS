...
\midrule
Tensi\'on en barras (\%) & 2026 & $+$0.235 & $+$0.623 & 0.304 \\
Tensi\'on en barras (\%) & 2028 & $+$0.235 & $+$0.624 & 0.304 \\
Cargabilidad de l\'ineas (p.p.) & 2026 & $+$1.876 & $+$23.814 & 6.310 \\
Cargabilidad de l\'ineas (p.p.) & 2028 & $+$1.871 & $+$23.803 & 6.296 \\
\bottomrule
\end{tabular}
\end{table}

El impacto del proyecto sobre la red existente es \textbf{marginal y acotado}. En tensi\'on, la desviaci\'on promedio es de $+$0.235\,\% y la m\'axima de $+$0.623\,\%, muy por debajo del umbral del 10\,\% que el numeral 10.1 de CREG 174 fija como causal de rechazo: el proyecto \emph{eleva} ligeramente el perfil de tensi\'on, efecto esperable de una inyecci\'on de potencia activa en un alimentador rural largo.

En cargabilidad, la desviaci\'on se reporta en \textbf{puntos porcentuales} y no en porcentaje relativo, porque este \'ultimo resulta enga\~noso en elementos poco cargados: un tramo que pasa de 7.6\,\% a 30.3\,\% de carga representa un $+$305\,\% relativo pero solo $+$22.7\,p.p.\ en t\'erminos absolutos, y sigue estando muy lejos de su l\'imite t\'ermico. El desglose elemento por elemento muestra que el cambio se concentra \'integramente en un solo tramo:

\begin{center}
\begin{tabular}{|l|r|}
\hline
\textbf{Elemento} & \textbf{Cambio promedio (p.p.)} \\ \hline
L\'inea \texttt{AL 1.32km} (evacuaci\'on del proyecto) & $+$22.718 \\ \hline
Las otras 11 l\'ineas del sistema & entre $-$0.075 y $+$0.018 \\ \hline
\end{tabular}
\end{center}

Es decir: \textbf{el proyecto no altera de forma apreciable la cargabilidad de ning\'un elemento de la red de EBSA}; el \'unico tramo que cambia de forma significativa es el que transporta su propia generaci\'on, y lo hace desde un nivel de carga muy bajo. Las 11 l\'ineas restantes var\'ian menos de 0.08\,p.p., una cifra despreciable.
...
Se simularon $2\ \text{a\~nos} \times 2\ \text{casos de red} \times 12\ \text{horas} = 48$ escenarios. \textbf{Los 48 convergieron}, sin excepciones.
...
\midrule
2026 & Sin proyecto & 0.9376 & P2 15302 / h15 & 1.0172 & P6 15344 / h7 \\
2026 & Con proyecto & 0.9375 & P2 15302 / h15 & 1.0230 & P6 15344 / h7 \\
2028 & Sin proyecto & 0.9369 & P2 15302 / h15 & 1.0168 & P6 15344 / h7 \\
2028 & Con proyecto & 0.9368 & P2 15302 / h15 & 1.0226 & P6 15344 / h7 \\
\bottomrule
\end{tabular}
\end{table}

\textbf{No se presenta ninguna violaci\'on del rango admisible} en ninguno de los 48 escenarios: la tensi\'on m\'as baja del sistema es 0.9368\,p.u.\ (a\~no $t+x$, hora de m\'axima demanda) y la m\'as alta 1.0230\,p.u., frente a los l\'imites de 0.90 y 1.10\,p.u. El margen contra subtensi\'on es de 3.7 puntos porcentuales y contra sobretensi\'on de 7.7 puntos. La tensi\'on m\'inima se da siempre en la barra P2 15302 a la hora 15 (m\'axima demanda del \'area) y no la causa el proyecto: es pr\'acticamente id\'entica con y sin \'el ($-$0.0001\,p.u.\ de diferencia), porque esa barra pertenece a otro circuito.
...
\midrule
2026 & Sin proyecto & 79.35\,\% (\texttt{Al 0.82km}, h15) & --- \\
2026 & Con proyecto & 79.37\,\% (\texttt{Al 0.82km}, h15) & 80.52\,\% (h16) \\
2028 & Sin proyecto & 80.22\,\% (\texttt{Al 0.82km}, h15) & --- \\
2028 & Con proyecto & 80.24\,\% (\texttt{Al 0.82km}, h15) & 80.55\,\% (h16) \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Ning\'un elemento del sistema supera el 100\,\% de cargabilidad} en condici\'on normal, en ninguno de los 48 escenarios. El elemento m\'as exigido de la red de EBSA es la l\'inea \texttt{Al 0.82km}, que alcanza 80.24\,\% en el a\~no $t+x$ a la hora de m\'axima demanda; el proyecto incrementa esa cifra en apenas 0.02 puntos porcentuales. El transformador propio del proyecto opera a 80.55\,\% de su capacidad nominal, coherente con una potencia de 990\,kW sobre un equipo de 1250\,kVA.
...
\begin{tabular}{lrrrr}
\toprule
A\~no / caso & Promedio (kW) & M\'inimo (kW) & M\'aximo (kW) & $\Delta$ promedio (kW) \\
\midrule
2026 sin proyecto & 118.25 & 77.67 & 152.72 & --- \\
2026 con proyecto & 127.50 & 88.18 & 163.33 & $+$9.26 \\
2028 sin proyecto & 120.50 & 78.94 & 155.67 & --- \\
2028 con proyecto & 129.70 & 89.42 & 166.25 & $+$9.21 \\
\bottomrule
\end{tabular}
\end{table}

Las p\'erdidas del sistema \textbf{aumentan} en promedio 9.26\,kW en el a\~no $t$ y 9.21\,kW en el a\~no $t+x$ (rango horario de $+$8.0 a $+$10.6\,kW). Este resultado merece explicaci\'on, porque contradice la intuici\'on habitual de que la generaci\'on distribuida reduce p\'erdidas al acercar la generaci\'on a la carga.

El desglose elemento por elemento muestra que el aumento \textbf{no est\'a repartido por la red, sino concentrado en un \'unico tramo}: la l\'inea \texttt{AL 1.32km}, que es precisamente la que evacua la energ\'ia del proyecto hacia el punto de conexi\'on, pasa de 0.62\,kW a 9.92\,kW de p\'erdidas ($+$9.30\,kW). Todas las dem\'as l\'ineas del sistema \textbf{reducen} ligeramente sus p\'erdidas al entrar el proyecto:

\begin{table}[H]
\centering
\caption{P\'erdidas activas por l\'inea, a\~no $t$, hora 15 (m\'axima demanda).}
\begin{tabular}{lrrr}
\toprule
L\'inea & Sin proyecto (kW) & Con proyecto (kW) & $\Delta$ (kW) \\
\midrule
\texttt{AL 1.32km} (evacuaci\'on) & 0.62 & 9.92 & $+$9.30 \\
\texttt{AL 4.2km} & 5.53 & 5.46 & $-$0.07 \\
\texttt{Al 14.833km} & 2.81 & 2.77 & $-$0.03 \\
\texttt{AL 2.64km} & 1.24 & 1.23 & $-$0.02 \\
Resto de l\'ineas & \multicolumn{3}{c}{variaciones inferiores a $\pm$0.02\,kW} \\
\midrule
Subtotal l\'ineas & 152.23 & 161.44 & $+$9.21 \\
\textbf{Total del sistema} (l\'ineas $+$ transformadores) & \textbf{152.23} & \textbf{161.58} & \textbf{$+$9.34} \\
\bottomrule
\end{tabular}
\end{table}

La lectura correcta es entonces: \textbf{el proyecto no degrada el desempe\~no de la red de EBSA}. Las p\'erdidas adicionales son el costo de transporte de su propia energ\'ia por el tramo de conexi\'on, y su magnitud (9.3\,kW frente a 990\,kW generados, es decir un 0.94\,\%) es normal para una conexi\'on de esta longitud. En el resto del sistema el efecto del proyecto es, como se esperaba, una reducci\'on marginal de p\'erdidas.

Conviene notar adem\'as que las p\'erdidas del transformador propio del proyecto no contribuyen a este delta: el modelo reporta p\'erdidas activas pr\'acticamente nulas en ese equipo, de modo que los 9.26\,kW son \'integramente p\'erdidas en el conductor de evacuaci\'on.
